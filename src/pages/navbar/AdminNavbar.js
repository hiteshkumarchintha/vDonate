        ...
        <header>
          <div class="container1">
            ...
            <div class="links">
              <ul>
                <li>
                  <Link to="/adminfeed">All Donations</Link>
                </li>
                <li>
                  <Link to="/allocated">Allocated</Link>
                </li>
                <li>
                ...
                <li>
                  {!localStorage.getItem("token") ? (
                    <form className="d-flex">
                      <Link to="/adminlogin" class="Dbtn">
                        Login
                      </Link>

                      <Link to="/adminsignup" class="Dbtn">
                        SignUp
                      </Link>
                    </form>
                  ) : (
                ...
                <nav className="navi">
                  <ul className="navi-ul">
                    <li className="navi-li">
                      <Link to="/adminfeed" className="navi-item">
                        All Donations
                      </Link>
                    </li>
                    <li className="navi-li">
                      <Link to="/allocated" className="navi-item">
                        Allocated
                      </Link>
                    </li>
                    <li className="navi-li">
                      <Link to="/delivered" className="navi-item">
                        Delivered
                      </Link>
                    </li>
                    ...
                    <li className="navi-li">
                      {!localStorage.getItem("token") ? (
                        <form className="d-flex">
                          <Link to="/adminlogin" className="Dbtn">
                            Login
                          </Link>

                          <Link to="/adminsignup" className="Dbtn">
                            SignUp
                          </Link>
                        </form>
                      ) : (
